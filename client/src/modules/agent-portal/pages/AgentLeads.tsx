  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-2xl font-bold text-text mb-1">My Leads</h1>
      ...
      <div className="bg-surface border border-border rounded-xl p-8 text-center">
        ...
        <h3 className="text-lg font-bold text-text mb-2">No active leads</h3>
        <p className="text-text-secondary">You don't have any leads assigned to you right now.</p>
      </div>
    </div>
  );
};
